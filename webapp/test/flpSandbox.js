		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Shell Plugin",
									"targetURL": "#demoshellplugin-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"demoshellplugin-display": {
								"semanticObject": "demoshellplugin",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=demo.shellplugin",
									"url": sap.ui.require.toUrl("demo/shellplugin")
								}
							}
						}
					}
